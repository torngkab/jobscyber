...
<TABLE FRAME=BORDER CELLSPACING=0 COLS=48 RULES=NONE BORDER=0>
	...
	<TBODY>
		...
		<TR>
			...
			<TD><BR></TD>
			<TD><BR></TD>
			<TD STYLE="border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" COLSPAN=9 ALIGN=CENTER><FONT FACE="Microsoft Sans Serif" size=3>ต้นฉบับ</FONT></TD>
			<TD><BR></TD>
			<TD><BR></TD>
		</TR>
		<TR>
