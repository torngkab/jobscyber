...
<?
	...
	//เลือกข้อมูลมาแสดง
	$strSQL = "select * from customer_check_see_status INNER JOIN customerbuffer ON customer_check_see_status.idcompany = customerbuffer.idcompany WHERE idresume='$_SESSION[resumeindex]'";
...
?>
	...
	<tr>
		<th>&nbsp;&nbsp;เปิดอ่านเมื่อวันที่&nbsp;&nbsp;</th>
		<th>&nbsp;&nbsp;ชื่อบริษัทที่ได้เปิดอ่าน&nbsp;&nbsp;</th>
		<th>&nbsp;&nbsp;เวลาที่เปิดอ่าน&nbsp;&nbsp;</th>
	</tr>
<?
