...
<TABLE FRAME=VOID CELLSPACING=0 COLS=40 RULES=NONE BORDER=0 BGCOLOR="#FFFFCC">
	...
	<TBODY>
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000; border-right: 1px solid #000000" COLSPAN=4 ALIGN=center><?  if  ($_SESSION['listen3'] != 0)  {  echo  encodelavel_th($_SESSION['listen3']);  }  ?></TD>
			<TD STYLE="border-bottom: 1px solid #000000; border-right: 1px solid #000000" COLSPAN=4 ALIGN=center><?  if  ($_SESSION['speak3'] != 0)  {  echo  encodelavel_th($_SESSION['speak3']);  }  ?></TD>
			<TD STYLE="border-bottom: 1px solid #000000; border-right: 1px solid #000000" COLSPAN=4 ALIGN=center><?  if  ($_SESSION['read3'] != 0)  {  echo  encodelavel_th($_SESSION['read3']);  }  ?></TD>
			<TD STYLE="border-bottom: 1px solid #000000; border-right: 1px solid #000000" COLSPAN=4 ALIGN=center><?  if  ($_SESSION['write3'] != 0)  {  echo  encodelavel_th($_SESSION['write3']);  }  ?></TD>
			</TR>
		<TR>
...
<a href=customer_search_resumeform_en.php?resumeindex=<?=$_GET[resumeindex];  ?>><img src=images/011.png border=0></a>&nbsp; &nbsp;
