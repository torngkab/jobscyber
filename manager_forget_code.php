...
<div align=center>
  ...
  <table width="456" height="212" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
    <tr>
      <td><div align="center">
        <table width="378"  border="0" cellpadding="0" cellspacing="0" bordercolor="#78CE31">
      <tr>
        <form method="post" action="manager_sending_code.php">
          <td class="PD3"><div align="right">ใส่ email ที่สมัครไว้</div></td>
          <td>&nbsp;</td>
          <td><div align="left">
            <input name="yourmail" type="text" class="PD3" size="38" value=<?=$_SESSION['ggyourmail'];  ?>>
            </div></td>
      </tr>
          <tr>
        ...
        <td valign="middle" ><div align="left" class="PD8">
          <input name="pincode" type="text" class="PD3" size="15" maxlength="8" /> &nbsp; &nbsp; <a href=manager_forget_code.php><font class=PD1>เปลี่ยน PIN CODE</font></a>
          </div></td>
      </tr>
          <tr>
            <td height="10">&nbsp;</td>
