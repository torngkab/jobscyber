...
<TABLE FRAME=VOID CELLSPACING=0 COLS=40 RULES=NONE BORDER=0 BGCOLOR="#FFFFCC">
	...
	<TBODY>
		...
		<TR>
			<TD STYLE="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" COLSPAN=7 ROWSPAN=8 HEIGHT=175><div align="center"><a href="employee_show_image.php">
                                                     <?  if  (!empty($_SESSION[image] ))  {  ?><img src=employee_show_image.php?resumeindex=<?=$_SESSION[resumeindex]; ?> border=0 width=185 height=180><?  }  elseif  (encodegender_th($_SESSION['gender']) == "ªÒÂ")  {  ?><img src=images/man.png border=0 width=185 height=180><?  }  elseif (encodegender_th($_SESSION['gender']) == "Ë­Ô§")  {  ?><img src=images/woman.png border=0 width=185 height=180><?  }  ?> </TD>
			<TD><BR></TD>
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000; border-right: 1px solid #000000" COLSPAN=4 ALIGN=center><?  if  ($_SESSION['listen3'] != "")  {  echo  encodelavel_en($_SESSION['listen3']);  }  ?></TD>
			<TD STYLE="border-bottom: 1px solid #000000; border-right: 1px solid #000000" COLSPAN=4 ALIGN=center><?  if  ($_SESSION['speak3'] != "")  {  echo  encodelavel_en($_SESSION['speak3']);  }  ?></TD>
			<TD STYLE="border-bottom: 1px solid #000000; border-right: 1px solid #000000" COLSPAN=4 ALIGN=center><?  if  ($_SESSION['read3'] != "")  {  echo  encodelavel_en($_SESSION['read3']);  }  ?></TD>
			<TD STYLE="border-bottom: 1px solid #000000; border-right: 1px solid #000000" COLSPAN=4 ALIGN=center><?  if  ($_SESSION['write3'] != "")  {  echo  encodelavel_en($_SESSION['write3']);  }  ?></TD>
			</TR>
		<TR>
